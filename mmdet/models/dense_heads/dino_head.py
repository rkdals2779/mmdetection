...
class DINOHead(DeformableDETRHead):
    ...
    @IOLogger("(base_detr)DetectionTransformer.loss -> DINOHead")
    ...
    @IOLogger("DINOHead.loss -> DINOHead")
    def loss_by_feat(
        self,
        ...
        IOLogger("DINOHead.loss_by_feat").log_var("loss_dict", loss_dict)
        ...
        if all_layers_denoising_cls_scores is not None:
            ...
            IOLogger("DINOHead.loss_by_feat").log_var("dn_losses_cls", dn_losses_cls)
            IOLogger("DINOHead.loss_by_feat").log_var("dn_losses_cls[-1]", dn_losses_cls[-1])
    ...
    def _loss_dn_single(self, dn_cls_scores: Tensor, dn_bbox_preds: Tensor,
        ...
        IOLogger("DINOHead._loss_dn_single").log_var("cls_scores", cls_scores)
        ...
        IOLogger("DINOHead._loss_dn_single").log_var("loss_cls", loss_cls)
