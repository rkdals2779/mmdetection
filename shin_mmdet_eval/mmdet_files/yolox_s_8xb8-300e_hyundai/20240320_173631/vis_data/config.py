...
data_root = '/home/rilab-shin/shin_work/dataset/Hyundai/hyundai_v3_FINAL/'
...
interval = 1
launcher = 'none'
load_from = '/home/rilab-shin/shin_work/mmdetection/tools/work_dirs/yolox_s_8xb8-300e_hyundai/epoch_300.pth'
log_level = 'INFO'
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            use_sigmoid=True),
        loss_hgt=dict(loss_weight=1.0, reduction='sum', type='SmoothL1Loss'),
    ...
    neck=dict(
        ...
        use_depthwise=False),
    test_cfg=dict(nms=dict(iou_threshold=0.5, type='nms'), score_thr=0.3),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/rilab-shin/shin_work/dataset/Hyundai/hyundai_v3_FINAL/',
        pipeline=[
...
work_dir = './work_dirs/yolox_s_8xb8-300e_hyundai'
